...
def voice_gen():
    ...
    XI_API_KEY = os.getenv("EAI_KEY")  # Your API key for authentication
    VOICE_ID = "oWAxZDx7w5VEj9dCyTzz"  # ID of the voice model to use
    TEXT_TO_SPEAK = "i want to break free from this economics class !"  # Text you want to convert to speech
